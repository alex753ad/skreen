...
def run_backtest(prices1, prices2, timeframe='4h', entry_z=None, exit_z=None,
    ...
    if entry_z is None: entry_z = CFG('strategy', 'entry_z', 2.0)
    if exit_z is None: exit_z = CFG('strategy', 'exit_z', 0.8)
    ...
    if take_profit_pct is None: take_profit_pct = CFG('strategy', 'take_profit_pct', 1.5)
